...
public class plot2 extends AppCompatActivity {

    Button A1,A2,A3,A4,book;
    private TextView selection;
    private EditText etname;
    private String result="";
    private String place = "Gate2";
    ...
    private void confirmmessage(String x){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(plot2.this,booked.class));
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(plot2.this, MainActivity.class));
            }
        });
        if(x.equals(""))
        {
